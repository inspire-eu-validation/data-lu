...
* Validate each document against the latest INSPIRE official schema(s), using strict XML schema validation. 
  ...
  *  Existing Land Use: https://inspire.ec.europa.eu/schemas/elu/4.0/ExistingLandUse.xsd
  *  Gridded Existing Land Use: https://inspire.ec.europa.eu/schemas/gelu/4.0/GriddedExistingLandUse.xsd
  *  Planned Land Use: https://inspire.ec.europa.eu/schemas/plu/4.0/PlannedLandUse.xsd
  *  Sampled Existing Land Use: https://inspire.ec.europa.eu/schemas/selu/4.0/SampledExistingLandUse.xsd
